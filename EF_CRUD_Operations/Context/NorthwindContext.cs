...
using Region = EF_CRUD_Operations.Models.Region;

namespace EF_CRUD_Operations.Context
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<VwCondimentsKategorisindeEnPahali5UrunBul> VwCondimentsKategorisindeEnPahali5UrunBuls { get; set; } = null!;
        public virtual DbSet<VwKritikSeviyeUrunBi1gileri> VwKritikSeviyeUrunBi1gileris { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VwCondimentsKategorisindeEnPahali5UrunBul>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_CondimentsKategorisindeEnPahali5UrunBul");
            ...
            modelBuilder.Entity<VwKritikSeviyeUrunBi1gileri>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_KritikSeviyeUrunBi1gileri");
